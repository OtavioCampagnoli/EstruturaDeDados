...
public class OrdenacaoInsertionSort {
    ...
    public OrdenacaoInsertionSort() {
        ...
        if (!insertionSort_v01(vetnulo)) {
            System.out.println("O vetor nulo 'vetnulo' ṇo pode ser ordenado em insertionSort_v01.");
        }

        try {
            insertionSort_v02(vetnulo);
        } catch (Exception ex) {
            System.out.println("O vetor nulo 'vetnulo' ṇo pode ser ordenado em insertionSort_v02.\n");
        }
         ...
         * }
         * catch(Exception ex ){
         * System.out.println("vet ṇo pode ser ordenado em insertionSort_v02...\n");
         * }
         */
