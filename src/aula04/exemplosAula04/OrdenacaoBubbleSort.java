...
public class OrdenacaoBubbleSort {
    ...
    public OrdenacaoBubbleSort() {
        ...
        if (!bubbleSort_v01(vetnulo)) {
            System.out.println("O vetor nulo 'vetnulo' nÃ£o pode ser ordenado em bubbleSort_v01.");
        }

        try {
            bubbleSort_v02(vetnulo);
        } catch (Exception ex) {
            System.out.println("O vetor nulo 'vetnulo' nÃ£o pode ser ordenado em bubbleSort_v02.\n");
        }
        ...
        bubbleSort_v05(vet); // ou executar as outras versÃµes disponÃ­veis
